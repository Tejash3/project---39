...
function preload(){
  sonic_running = loadAnimation("Images/sonic.png");
  sonic_collided = loadAnimation("Images/soniccolided.png");
  
  groundImage = loadImage("ground2.png");
  
  cloudImage = loadImage("cloud.png");
  
  obstacle1 = loadImage("Images/crab.png");
  obstacle2 = loadImage("Images/monster.png");
